...
export const utbildning = {
  ...
  "Stockholms Universitet": {
    ...
    desc: [
      ...
      "Blues, jazz och modern populärmusik 15 hp (2011)",
      "Religionshistoria 30hp (2012)",
    ],
  },
  Linnéuniversitetet: {
    school: "Fristående kurser",
...
export const gymnasial = {
  ...
  "Jensen Komvux": {
    ...
    desc: [
      ...
      "Webbutveckling 1 - 100p (2020)",
      "Webbutveckling 2 - 100p (2020)",
    ],
  },
  "NTI-skolan": {
    school: "Fristående kurser",
...
export const yrke = {
  "Folkparksvägens gruppbostad": {
    title: "Vårdare",
    desc: [
      "Assisterat boende på gruppbostaden i dagliga sysslor och aktiviteter.",
      "Tagit fram arbetsmaterial i Office-paket.",
    ],
    year: "2015-2019",
  },
  Mysafety: {
    title: "Telefonförsäljare",
    desc: ["Sålde in Mysafetys säkerhetslösningar via telefon."],
    year: "2012-2014",
  },
  Vendator: {
    title: "Telefonförsäljare",
    desc: ["Sålde in tjänster och abonnemang i uppdrag för Vendators Kunder."],
    year: "2007-2011",
  },
  Debaser: {
    title: "Diskare/Barback",
    desc: ["Diskare/garderob/barback."],
    year: "2008-2010",
  },
}
